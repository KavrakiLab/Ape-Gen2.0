...
class Peptide(object):
    """ 
    The Peptide class is used to represent, model, and perform modifications on a peptide between 8 and 15 amino acids
    in length


    Atributes
    ---------
    sequence:       str of the amino acid sequence of the peptide
    pdb_filename:   str for the name of the PDB file representing the peptide structure
    pdbqt_filename: str for the name of the PDBQT file representing the peptide prepared for scoring
    anchors:        str of the residues of the peptide that act as anchors on the receptors  
